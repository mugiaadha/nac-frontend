      ...
      <div className="lg:py-0 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="#"
              className="hidden lg:block bg-primary text-white hover:bg-primary/15 hover:text-primary px-6 py-2 rounded-full text-base font-medium"
              onClick={() => {
            ...
            <Link
              href="#"
              className="hidden lg:block bg-primary/15 hover:bg-primary text-primary hover:text-white px-6 py-2 rounded-full text-base font-medium"
              onClick={() => {
